    ...
    return (
        <div className='w-full flex justify-center my-[5rem] relative overflow-hidden'>
            ...
            <div className="w-full max-w-[90rem] relative z-[3] flex flex-col gap-8 items-center p-4 py-[4rem] md:p-[4rem]">
                <h2 className="text-2xl md:text-5xl text-center text-textcolor font-semibold tracking-[0.5rem] md:tracking-[1rem]">GET IN TOUCH</h2>
                <span className="flex gap-8 text-xl text-textcolor items-center">
                ...
                <button className='p-3 px-6 bg-goldCardBg border border-transparent' onClick={() => {
