...
const WhatWeDo = () => {
    return (
        <Element name='whyquranile' className='w-full flex justify-center md:max-h-[42rem] bg-secondary pr-4 md:pr-[4rem]'>
            <div className="w-full flex flex-col md:flex-row gap-[2rem] md:gap-[4rem]">
                <div className="w-full md:w-[40%]">
                    <img src="/wwd.png" alt="Why Quranile" className="w-full h-auto object-cover" />
                </div>
                <div className="w-full px-4 md:px-0 max-w-xl md:w-1/2 py-10">
                    <h2 className="text-3xl font-bold mb-4 text-gray-800">Why Quranile?</h2>
                    ...
                    <div className="mt-6 text-gray-800">
                        ...
                        <p className="mb-4">
                            Quranile is about reading the Quran but also about living it — beautifully, correctly, and with a connection that transforms.
                        </p>
                        <p className="mb-4">
