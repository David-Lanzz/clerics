...
const steps = [
    {
        ...
        desc: "Start by providing your name, contact info, and time zone. You’ll also create your Quranile portal login.",
    },
    {
            ...
            <div className="w-full max-w-[90rem] flex flex-col-reverse md:flex-row gap-16 items-center">
                ...
                >
                    ...
                    <p className="text-lg text-gray-300">
                        Ready to embark on your Quranile journey? In just a few easy steps, you can schedule your first free session – no payment needed upfront.
                    </p>
