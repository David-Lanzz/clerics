        ...
        <div className="w-full h-[100svh] flex bg-gray-100">
            ...
            >
                ...
                <nav className="flex flex-col gap-4">
                    {/* <button className="bg-secondary p-2 px-6 text-primary rounded-md" onClick={() => handleNavigation(`/admin/${id}`, 'clerics')}>Clerics</button> */}
                    <button className="bg-secondary p-2 px-6 text-primary rounded-md" onClick={() => handleNavigation('', 'bookings')}>Bookings</button>
                    <button className="bg-secondary p-2 px-6 text-primary rounded-md" onClick={() => handleNavigation(`/`, 'home')}>Back to Home</button>
                </nav>
            </aside>
